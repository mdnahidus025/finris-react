...
import serviceImg1 from "../../assets/images/services/services-details-img-4.jpg";

import serviceImg2 from "../../assets/images/services/services-details-img-2.jpg";
import pointsImg from "../../assets/images/services/services-details-points-img-1.jpg";
import icon1 from "../../assets/images/icon/services-details-icon-1.png";
import icon2 from "../../assets/images/icon/services-details-icon-2.png";
import icon3 from "../../assets/images/icon/services-details-icon-3.png";
import icon4 from "../../assets/images/icon/services-details-icon-4.png";
                    ...
                    <div className="col-xl-8 col-lg-7">
                        <div className="services-details__left">
                            <div className="services-details__img">
                                <img src={serviceImg1} alt="Digital Marketing Service" />
                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-6">
                                            <div className="services-details__points-img">
                                                <img src={pointsImg} alt="Service Points" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
