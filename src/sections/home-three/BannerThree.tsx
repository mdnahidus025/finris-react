...
import client_one from "../../assets/images/resources/banner-two-satisfied-client-1-1.jpg"
import client_two from "../../assets/images/resources/banner-two-satisfied-client-1-2.jpg"
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-5 col-lg-6">
                            <div className="banner-two__img-box" >
                                <div
                                    className="banner-two__img float-bob-y">
                                    <motion.img initial={{ y: 80, opacity: 0 }}
                                        whileInView={{ y: 0, opacity: 1 }}
                                        transition={{
                                            duration: 1.3,
                                            ease: "easeOut"
                                        }}
                                        viewport={{ amount: 0.01 }} src={bannerImg} alt="Image" />
                                    <div className="banner-two__img-shape-box">
                                        <div

                                            className="banner-two__img-shape-1" >
                        ...
                        <div className="col-xl-3">
                            <div className="banner-two__right" data-aos="slide-left" data-aos-duration="1200"
                                ...
                                <div className="banner-two__active-customer-img-box">
                                    <motion.img initial={{ x: 80, opacity: 0 }}
                                        whileInView={{ x: 0, opacity: 1 }}
                                        transition={{
                                            duration: 1.3,
                                            ease: "easeOut"
                                        }}
                                        viewport={{ amount: 0.1 }} src={customerImg} alt="Image" />
                                </div>
