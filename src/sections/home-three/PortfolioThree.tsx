...
import shapeBg from '../../assets/images/shapes/portfolio-one-shape-bg.jpg';
import shapeBgTwo from '../../assets/images/shapes/portfolio-one-shape-bg-two.jpg';
import { portfolioItemsThree } from '../../contents/portfolio/portfolio';
import type { PortfolioItemThree } from '../../contents/portfolio/portfolioType';
                                    ...
                                    <div className="portfolio-one__img-box">
                                        ...
                                        <div className="portfolio-one__content">
                                            ...
                                            <div className="portfolio-one__btn-box">
                                                <Link to={item.link} className="portfolio-one__btn thm-btn">
