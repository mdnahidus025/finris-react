...
// Import images
import shapeBg1 from '../../assets/images/shapes/testimonial-two-shape-bg-1.png';
import shapeBg2 from '../../assets/images/shapes/testimonial-two-shape-bg-2.png';
...
import type { TestimonialTwo } from '../../contents/testimonials/type';
            ...
            <div className="container">
                <div className="section-title-two text-left sec-title-animation animation-style2">
                    ...
                    <h2 className="section-title-two__title title-animation">
                        ...
                        <TextAnimation text='are saying about us.' isSpan={false} textColor='#6232F8' />
