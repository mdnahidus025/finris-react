...
import img1 from "../../assets/images/resources/why-choose-one-img-1.jpg";
                        ...
                        <div className="why-choose-one__left">
                            <div className="section-title text-left sec-title-animation animation-style2">
                                ...
                                <h2 className="section-title__title title-animation">
                                    <TextAnimation text="We're a top creative agency" fontSize='32' textColor="black" />
                                    <TextAnimation text="known for innovation." fontSize='32' />
                                    <span></span>
                                </h2>
                            </div>
                            ...
                            <ul className="list-unstyled why-choose-one__list">
                                ...
                                <li>
                                    <div className="icon">
                                        <img src={icon2} alt="Creative Excellence" />
                                    </div>
                                    <div className="content">
                                        <p>
                                ...
                                <li>
                                    <div className="icon">
                                        <img src={icon3} alt="Custom Strategies" />
                                    </div>
                                    <div className="content">
                                        <p>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6">
                                    <div className="why-choose-one__content-one">
                                        <div className="why-choose-one__img-one">
                                            <img src={img1} alt="Why Choose One 1" />
                                        </div>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6">
                                    <div className="why-choose-one__content-two">
                                        ...
                                        <div className="why-choose-one__img-two">
                                            <img src={img2} alt="Why Choose One 2" />
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
