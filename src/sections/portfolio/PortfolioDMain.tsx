...
import mainImg from "../../assets/images/project/portfolio-details-img-1.jpg";
import boxImg1 from "../../assets/images/project/portfolio-details-img-box-img-1.jpg";
import boxImg2 from "../../assets/images/project/portfolio-details-img-box-img-2.jpg";
import boxTwoImg1 from "../../assets/images/project/portfolio-details-img-box-two-img-1.jpg";
import boxTwoImg2 from "../../assets/images/project/portfolio-details-img-box-two-img-2.jpg";
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="portfolio-details__right">
                                <div className="portfolio-details__img">
                                    <img src={mainImg} alt="Portfolio main" />
                                </div>
                                ...
                                <div className="portfolio-details__content">
                                    ...
                                    <p className="portfolio-details__text-2">
                                        Enhance brand recognition with focused online advertising. Direct traffic to the client's website and
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6 col-md-6">
                                                <div className="portfolio-details__img-box-img">
                                                    <img src={boxImg1} alt="Case study 1" />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6 col-md-6">
                                                <div className="portfolio-details__img-box-img-2">
                                                    <img src={boxImg2} alt="Case study 2" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="portfolio-details__img-box-2">
                                                    <div className="portfolio-details__img-box-two-img">
                                                        <img src={boxTwoImg1} alt="Extra image 1" />
                                                    </div>
                                                    <div className="portfolio-details__img-box-two-img">
                                                        <img src={boxTwoImg2} alt="Extra image 2" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <p className="portfolio-details__text-5">
                                        ...
                                        marketing strategy aligned with the client's objectives.
                                    </p>
                                    ...
                                    <p className="portfolio-details__text-6">
                                        ...
                                        elements that contributed to the project's success.
                                    </p>
