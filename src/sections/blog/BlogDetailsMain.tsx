...
import prevImg from "../../assets/images/blog/blog-details-prev-img.jpg";
import nextImg from "../../assets/images/blog/blog-details-next-img.jpg";
import commentIcon from "../../assets/images/icon/comment-one-title-icon.png";
                    ...
                    <div className="col-xl-8 col-lg-7">
                        <div className="blog-details__left">
                            <div className="blog-details__img">
                                <img src={mainImg} alt="Blog Details" />
                            </div>
                            ...
                            <div className="blog-details__content">
                                ...
                                <p className="blog-details__text-1">
                                    ...
                                    Whether you're a seasoned designer or just starting out, this guide will walk you through every phase
                                    of the process.
                                </p>
                                <p className="blog-details__text-2">
                                    With practical tips, real-world examples, and expert advice, you'll be equipped to tackle any web
                                ...
                                <div className="comment-one">
                                    ...
                                    <ul className="comment-one__list list-unstyled">
                                        <li>
                                            <div className="comment-one__single">
                                                <div className="comment-one__image">
                                                    <img src={comment1} alt="Comment Author" />
                                                </div>
                                        ...
                                        <li>
                                            <div className="comment-one__single">
                                                <div className="comment-one__image">
                                                    <img src={comment2} alt="Comment Author" />
                                                </div>
                                                <div className="comment-one__content">
                                        ...
                                        <li>
                                            <div className="comment-one__single">
                                                <div className="comment-one__image">
                                                    <img src={comment3} alt="Comment Author" />
                                                </div>
                                                <div className="comment-one__content">
                                ...
                                <div className="comment-form">
                                    <div className="comment-one__title-box">
                                        <div className="comment-one__title-icon">
                                            <img src={commentIcon} alt="Form Icon" />
                                        </div>
