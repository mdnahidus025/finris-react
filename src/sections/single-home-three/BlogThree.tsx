            ...
            <div className="container">
                ...
                <div className="section-title-two text-center sec-title-animation animation-style1">
                    ...
                    <h2 className="section-title-two__title title-animation">
                        <TextAnimation text='Check out our articles to learn' isSpan={false} textColor='black' />
                        <TextAnimation text='more about business agencies.' isSpan={false} textColor="#6232F8" />
                    </h2>
                </div>
